...
public class ProjetListView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setFont(new java.awt.Font("Traditional Arabic", 2, 24)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("Tempus Sans ITC", 2, 18)); // NOI18N
        ...
        jLabel9.setText("LISTE DES PROJETS");

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/equie.jpg"))); // NOI18N
     ...
     private Projet getParam() {
        ...
        p.setAvancement(new Double(jTextField3.getText() + ""));
        p.setDebut_projet(jDateChooser1.getDate());
        p.setFin_projet(jDateChooser2.getDate());
        p.setJour_homme(new Integer(jTextField4.getText()+""));
        p.setNom(jTextField5.getText()+"");
        return p;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        projetService.remove(projetHelper.getSelected());
        projetHelper.remove(projetHelper.getSelected());
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        // TODO add your handling code here:
      Projet p=projetHelper.getSelected();
      jTextField1.setText(p.getId()+"");
      jTextField5.setText(p.getNom()+"");
      jTextField3.setText(p.getAvancement()+"");
      jTextField2.setText(p.getMontant()+"");
      jTextField4.setText(p.getJour_homme()+"");
      jDateChooser1.setDate(p.getDebut_projet());
      jDateChooser2.setDate(p.getFin_projet());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjetListView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
